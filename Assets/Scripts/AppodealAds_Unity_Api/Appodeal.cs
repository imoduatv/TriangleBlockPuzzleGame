...
namespace AppodealAds.Unity.Api
{
	public class Appodeal
	{
		...
		public const string APPODEAL_PLUGIN_VERSION = "2.8.53";
		...
		public static string getUnityVersion()
		{
			...
			{
				PropertyInfo property = typeof(Application).GetProperty("identifier", BindingFlags.Static | BindingFlags.Public);
				text = ((property == null) ? "5.5-" : "5.6+");
			}
			return text;
		}
	}
