...
namespace Dta.TenTen.Hexagonal
{
	public class ShapeRotate
	{
		...
		{
			circle1.Clear();
			circle1.Add(mapIn[2, 1]);
			circle1.Add(mapIn[3, 2]);
			circle1.Add(mapIn[3, 3]);
			circle1.Add(mapIn[2, 3]);
			circle1.Add(mapIn[1, 2]);
			circle1.Add(mapIn[1, 1]);
		}
		...
		private void CreateCircle2()
		{
			...
			circle2.Add(mapIn[4, 2]);
			circle2.Add(mapIn[4, 3]);
			circle2.Add(mapIn[4, 4]);
			circle2.Add(mapIn[3, 4]);
			circle2.Add(mapIn[2, 4]);
			circle2.Add(mapIn[1, 3]);
			circle2.Add(mapIn[0, 2]);
			circle2.Add(mapIn[0, 1]);
			circle2.Add(mapIn[0, 0]);
			circle2.Add(mapIn[1, 0]);
		}
		...
		private void SetCircle2()
		{
			...
			circle2[8] = mapIn[0, 2];
			circle2[9] = mapIn[0, 1];
			circle2[10] = mapIn[0, 0];
			circle2[11] = mapIn[1, 0];
		}
		...
		private void ApplyCircle2()
		{
			...
			mapIn[0, 2] = circle2[8];
			mapIn[0, 1] = circle2[9];
			mapIn[0, 0] = circle2[10];
			mapIn[1, 0] = circle2[11];
		}
