...
{
	Action<MNT_PlayerTemplate> NI_OnRoomCreated
	{
		get;
		set;
	}

	Action<MNT_PlayerTemplate> NI_OnPlayerConnected
	{
		get;
		set;
	}

	Action<string> NI_OnPlayerDisconnected
	{
		get;
		set;
	}

	Action<MNT_PlayerTemplate> NI_OnConnectedToServer
	{
		get;
		set;
	}

	Action NI_OnDisconnectedFromServer
	{
		get;
		set;
	}

	Action<byte[]> NI_OnDataReceived
	{
		get;
		set;
	}
