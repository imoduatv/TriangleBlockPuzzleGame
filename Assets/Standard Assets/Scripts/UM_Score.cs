...
public class UM_Score
{
	...
	public UM_Player Player => player;

	public GK_Score GameCenterScore => _GK_Score;

	public GPScore GooglePlayScore => _GP_Score;

	public GC_Score GameCircleScore => _GC_Score;
